    ...
    <HighchartsProvider Highcharts={Highcharts}>
      <HighchartsStockChart updateArgs={[true, true, true]}>
        ...
        <Loading isLoading={!loaded}>
          <LoaderSkeleton type="Paragraphs" bars={8} thickness={20} width="100%" height="200" />
        </Loading>
        ...
        <YAxis opposite labels={{ formatter: fmtShortNumber, x: -10, align: "right" }}>
          ...
          <ColumnSeries id="volume" color="#0a58ca" name={formatFirstUpper(t("volume"))} data={data1.total_volumes} />
          <AreaSplineSeries
            id="cap"
            color="#ead274"
            opacity={0.25}
        ...
        <YAxis opposite={false} labels={{ formatter: fmtContextPrice, x: 0, align: "left" }}>
          ...
          <LineSeries id="price" color="rgb(32,253,13)" name={formatFirstUpper(t("price"))} data={data1.prices} />
        </YAxis>
        {/* <YAxis opposite>
